...
import LeadAudit from './LeadAudit.jsx';

function Logo() {
  return <img src="/logo.png" width="32" height="32" style={{ borderRadius: 8, display: 'block' }} alt="Scale Cases" />;
}

const TABS = ['Ads Tracking', 'Spend Sheet', 'Campaign Reports', 'Ads Launcher', 'State Variations', 'Lead Audit'];
  ...
  return (
    <div className="app">
      ...
      <main className="content" style={{ padding: 0, boxSizing: 'border-box', minWidth: 0, overflow: 'clip' }}>
        ...
        {mounted.has('Lead Audit')       && <div style={show('Lead Audit')}><LeadAudit /></div>}
      </main>
    </div>
  );
}
