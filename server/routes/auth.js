// App-password authentication for internal staff.
// All Meta Marketing API calls use a System User Access Token (FB_ACCESS_TOKEN)
// configured in Business Manager — no end-user Facebook Login flow exists.
